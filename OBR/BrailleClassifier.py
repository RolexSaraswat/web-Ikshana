...
class BrailleClassifier(object):
    symbol_table = {
         ...
         (0,1,0,0,0,0): Symbol(',',letter=True),
         (0,1,1,0,0,0): Symbol(';',letter=True),
         (0,1,0,0,1,0): Symbol(':',letter=True),
         (0,1,1,0,1,0): Symbol('!',letter=True),
         (0,1,1,0,1,1): Symbol('()',letter=True),
